  ...
  static_cast<DummyTransport&>(getTransport()).onSendBlock.connect([this] (Block packet) {
    ...
    if (block.type() == tlv::Interest) {
      ...
      if (lpPacket.has<lp::NackField>()) {
        ...
        addTagFromField<lp::BierBitStringTag, lp::BierBitStringField>(*interest, lpPacket);
...
DummyClientFace::receive(const Interest& interest)
{
  ...
  addFieldFromTag<lp::BierBitStringField, lp::BierBitStringTag>(lpPacket, interest);
